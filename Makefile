#############################################################################
# Makefile for building: PorygonTracker.app/Contents/MacOS/PorygonTracker
# Generated by qmake (3.1) (Qt 6.11.0)
# Project:  PorygonTracker.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile PorygonTracker.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = PorygonTracker1.0.0
DISTDIR = /Users/george/dev/JP-Porygon-TCG-Tracker/.tmp/PorygonTracker1.0.0
...
EXPORT_QMAKE_MAC_SDK_VERSION = 26.4.1
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/george/dev/JP-Porygon-TCG-Tracker/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/george/dev/JP-Porygon-TCG-Tracker/PorygonTracker.pro
...
PorygonTracker.app/Contents/MacOS/PorygonTracker:  $(OBJECTS)  
	@test -d PorygonTracker.app/Contents/MacOS/ || mkdir -p PorygonTracker.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: PorygonTracker.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile PorygonTracker.pro
...
PorygonTracker.app/Contents/PkgInfo: 
	@test -d PorygonTracker.app/Contents || mkdir -p PorygonTracker.app/Contents
	@$(DEL_FILE) PorygonTracker.app/Contents/PkgInfo
	@echo "APPL????" > PorygonTracker.app/Contents/PkgInfo
PorygonTracker.app/Contents/Info.plist: 
	@test -d PorygonTracker.app/Contents || mkdir -p PorygonTracker.app/Contents
	@$(DEL_FILE) PorygonTracker.app/Contents/Info.plist
	@set -o pipefail && plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.PorygonTracker,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.PorygonTracker,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,PorygonTracker,g" -e "s,@LIBRARY@,PorygonTracker,g" -e "s,\$${EXECUTABLE_NAME},PorygonTracker,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >PorygonTracker.app/Contents/Info.plist

all: Makefile \
		PorygonTracker.app/Contents/PkgInfo \
		PorygonTracker.app/Contents/Info.plist PorygonTracker.app/Contents/MacOS/PorygonTracker
